...
Msg.factory = (options = {}) => {
  ...
  if ((Msg.msg === undefined) && (instance.options.id !== `__internal_instance__`)) {
    ...
    let css = `
		...
		.Msg-window-inner-x-blue:hover{background-color: #476b8f !important}
		.Msg-overlay-x-blue{color: white}
		.Msg-overlay-x-blue:hover{background-color: #747484 !important}
		...
		.Msg-window-inner-x-red:hover{background-color: #9d4d4d !important}
		.Msg-overlay-x-red{color: white}
		.Msg-overlay-x-red:hover{background-color: #805e5e !important}
		...
		.Msg-window-inner-x-green:hover{background-color: #4e8456 !important}
		.Msg-overlay-x-green{color: white}
		.Msg-overlay-x-green:hover{background-color: #7c957c !important}
		...
		.Msg-window-inner-x-black:hover{background-color: #424242 !important}
		.Msg-overlay-x-black{color: white}
		.Msg-overlay-x-black:hover{background-color: #686868 !important}
		`
